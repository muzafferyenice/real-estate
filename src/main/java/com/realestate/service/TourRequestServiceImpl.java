...
public class TourRequestServiceImpl implements ITourRequestService{
    ...
    @Override
    public List<TourRequest> findAllTourRequest(TourRequestStatus tourRequestStatus) {
        return tourRequestRepository.findAll();
    }

    @Override
    public TourRequest findByIdTourRequest(Long tourRequestId) throws ResourceNotFoundException {
        return tourRequestRepository.findById(tourRequestId).orElseThrow(()->
    ...
    @Override
    public void deleteTourRequest(Long tourRequestId) {
    ...
    public boolean checkPropertyAvailability(Long propertyId,LocalDateTime firstDate,LocalDateTime lastDate){
        ...
        List<TourRequest> existReservations = tourRequestRepository.yahya(propertyId,firstDate,lastDate,status);
